...
def save_cocsr_checkpoint(epoch, model_state, optim_state, logdir):
    last_model = os.path.join(logdir, 'last.cocsr_model')
    last_optim = os.path.join(logdir, 'last.cocsr_optim')
    last_config = os.path.join(logdir, 'last.cocsr_config')
